...
export default function Embed() {
  ...
  const embedCode =
    typeof window !== "undefined"
      ? `<iframe src="${window.location.origin}/embed/${checkId}" width="520" height="220" frameborder="0" title="TruthLock verdict"></iframe>`
      : `<iframe src="/embed/${checkId}" width="520" height="220" frameborder="0"></iframe>`;
